...
/**
 * Chunk decoder for the surface wind section
 */
class SurfaceWindChunkDecoder extends TafChunkDecoder implements TafChunkDecoderInterface
{
    public function getRegexp()
    {
        $direction = "([0-9]{3}|VRB|///)";
        $speed = "P?([/0-9]{2,3}|//)";
        $speed_variations = "(GP?([0-9]{2,3}))?"; // AKA gusts - optional
        $unit = "(KT|MPS|KPH)";
        $direction_variations = "( ([0-9]{3})V([0-9]{3}))?"; // optional
